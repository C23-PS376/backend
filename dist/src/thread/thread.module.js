...
ThreadModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([thread_entity_1.Thread, topic_entity_1.Topic]), jwtModule_1.jwtModule, multer_config_1.multerModule],
        controllers: [thread_controller_1.ThreadController],
        providers: [thread_service_1.ThreadService, storage_service_1.StorageService, topics_service_1.TopicsService],
    })
], ThreadModule);
